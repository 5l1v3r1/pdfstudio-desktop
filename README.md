...
To run the Docker image, first download the script [`pdfstudio_desktop.py`](https://raw.githubusercontent.com/x11vnc/pdfstudio-desktop/master/pdfstudio_desktop.py)
...
```
curl https://raw.githubusercontent.com/x11vnc/pdfstudio-desktop/master/pdfstudio_desktop.py -outfile pdfstudio_desktop.py
```
On Linux or Mac, start a terminal, use the `cd` command to change to the working directory, and then run the following command:
```
curl -s -O https://raw.githubusercontent.com/x11vnc/pdfstudio-desktop/master/pdfstudio_desktop.py
```

After downloading the script, you can start the Docker image using the command
```
python pdfstudio_desktop.py -p
```
...
```
python pdfstudio_desktop.py -v myproject
```
and the work directory will be the data volume.

For additional command-line options, use the command
```
python pdfstudio_desktop.py -h
```
